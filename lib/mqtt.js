...
client.on( 'message', (topic, value) => module.exports.emit('message', { topic, value: value.toString() }))

module.exports.publish = (topic, value, options) => client.publish(topic, String(value), options )